...
ActiveRecord::Schema.define(version: 2022_06_20_022029) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "beatcategories", force: :cascade do |t|
    t.bigint "beat_id", null: false
    t.bigint "category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["beat_id"], name: "index_beatcategories_on_beat_id"
    t.index ["category_id"], name: "index_beatcategories_on_category_id"
  end

  create_table "beats", force: :cascade do |t|
    t.string "beat_title", null: false
  ...
  add_foreign_key "beatcategories", "beats"
  add_foreign_key "beatcategories", "categories"
